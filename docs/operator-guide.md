...
- safety-critical escalation path (rotating-machinery hazard,
  tooling-change injury risk, metal-shaving hazard)
- provenance for all operating records (worker and workshop both
  independently registered)
- human review for high-risk cases
- audit export for all gated actions
- a hard, unconditional block on any attempt to route a machine-setup
  or machining-execution decision, or a shop-safety-officer-override
...
humans, and that no deployment configuration can route a machine-setup
or machining-execution decision or a shop-safety-officer judgment
