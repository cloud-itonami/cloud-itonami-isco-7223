...
`cloud-itonami-isco-7223` is an OSS open-occupation blueprint. Governance
...
- Machinist Governor remains independent of the advisor.
- hard policy violations cannot be overridden by human approval.
- a machine-setup or machining-execution decision, and any override
  of a shop safety officer's judgment, stay permanently outside this
...
- attempting to route a machine-setup or machining-execution decision,
